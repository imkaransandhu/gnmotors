					...
					'top_bar_wpml_switcher'         =>
						array(
							...
							'dependency'  => array(
								...
								'section' => 'general_tab',
								'value'   => 'car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||car_dealer_two||car_dealer_two_elementor||car_magazine||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||listing_six||motorcycle||aircrafts||boats||car_rental||service',
							),
							'submenu'     => esc_html__( 'Main', 'stm_motors_extends' ),
						),
