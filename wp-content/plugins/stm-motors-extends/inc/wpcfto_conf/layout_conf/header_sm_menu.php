		...
		$config = array(
			...
			'menu_icon_top_margin'               =>
				array(
					...
					'dependency' => array(
						'key'   => 'header_layout',
						'value' => 'aircrafts||boats||car_dealer_two||car_dealer_two_elementor||car_magazine||car_rental||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||listing_six',
					),
			...
			'hma_background_color'               =>
				...
				',
					...
					'dependency'  => array(
						'key'   => 'header_layout',
						'value' => 'car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||motorcycle',
					),
					'submenu'     => esc_html__( 'Menu', 'stm_motors_extends' ),
				),
			'hma_item_bg_color'                  =>
			...
			'hma_hover_text_color'               =>
				array(
					...
					'dependency'      => array(
						array(
							'key'   => 'header_layout',
							'value' => 'aircrafts||ev_dealer||car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||car_magazine||car_rental||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||listing_six||motorcycle||service',
						),
						array(
							'key'     => 'header_current_layout',
							'value'   => 'service',
