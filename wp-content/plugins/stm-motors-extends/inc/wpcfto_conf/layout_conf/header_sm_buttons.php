		...
		$config = array(
			...
			'header_compare_show'                  =>
				array(
					...
					'dependency' => array(
						...
						'value'   => 'aircrafts||boats||motorcycle||equipment||ev_dealer||car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||car_dealer_two||car_dealer_two_elementor||car_magazine||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||listing_six',
						'section' => 'general_tab',
					),
					'submenu'    => esc_html__( 'Buttons/Actions', 'stm_motors_extends' ),
				),
			...
			'header_cart_compare_hover_text_color' =>
				array(
					...
					'output'          => 'body #wrapper .header-help-bar > ul li a:hover .list-label,
							...
							.stm-layout-header-ev_dealer #wrapper #header .stm-header-right .lOffer-compare:hover i,
							.stm-layout-header-ev_dealer #wrapper #header .stm-header-right .lOffer-compare:hover i,
							.stm-layout-header-ev_dealer #wrapper #header .stm-header-right .help-bar-shop a:hover i,
			...
			'header_profile_hover_bg'              =>
				array(
					...
					'output'     => '
						 ...
						 .stm-layout-header-ev_dealer .lOffer-account-unit .lOffer-account:hover,
			...
			'header_profile_hover_text_color'      =>
				array(
					...
					'mode'            => 'color',
					'output'          => '
						.stm-layout-header-listing #wrapper #header .header-listing .listing-right-actions .pull-right .lOffer-account-unit .lOffer-account:hover i:before,
						 #wrapper #stm-boats-header #header .header-inner-content .listing-right-actions .lOffer-account-unit a:hover i,
						 .stm-layout-header-ev_dealer .lOffer-account-unit .lOffer-account:hover i,
			...
			'header_listing_btn_text'              =>
				array(
					...
					'dependency'   => array(
						...
						array(
							'key'   => 'header_layout',
							'value' => 'aircrafts||boats||ev_dealer||car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||car_dealer_two||car_dealer_two_elementor||car_magazine||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||motorcycle',
						),
						array(
			...
			'header_listing_btn_bg_color'          =>
				array(
					...
					'dependency'   => array(
						...
						array(
							'key'   => 'header_layout',
							'value' => 'aircrafts||boats||equipment||ev_dealer||car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||car_dealer_two||car_dealer_two_elementor||car_magazine||car_rental||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||listing_six',
						),
						array(
							'key'   => 'header_show_add_car_button',
							'value' => 'not_empty',
			...
			'header_listing_btn_text_color'        =>
				array(
					...
					'dependency'      => array(
						...
						array(
							'key'   => 'header_layout',
							'value' => 'aircrafts||boats||equipment||ev_dealer||car_dealer_elementor||car_dealer_elementor_rtl||car_dealer||car_dealer_two||car_dealer_two_elementor||car_magazine||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_four||listing_four_elementor||listing_five||listing_six',
						),
						array(
							'key'   => 'header_show_add_car_button',
							'value' => 'not_empty',
