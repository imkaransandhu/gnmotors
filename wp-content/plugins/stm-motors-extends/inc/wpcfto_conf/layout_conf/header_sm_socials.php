		...
		$config = array(
			...
			'soc_empty_notice'      =>
				array(
					...
					'dependency' => array(
						'key'   => 'header_layout',
						'value' => 'ev_dealer||car_dealer_two||car_dealer_two_elementor||aircrafts||boats||equipment||listing||listing_one_elementor||listing_two||listing_three||listing_three_elementor||listing_five||car_rental||service',
					),
					'submenu'    => esc_html__( 'Socials', 'stm_motors_extends' ),
				),
		);
