...
function stm_get_custom_taxonomy_count( $slug, $taxonomy ) {
	...
	return apply_filters( 'stm_get_custom_taxonomy_count', $total, $slug, $taxonomy );
}
...
function stm_get_category_by_slug_all( $slug, $is_add_car = false ) {
	$result = null;
	...
	return apply_filters( 'stm_get_category_by_slug_all', $result, $slug, $is_add_car );
}
